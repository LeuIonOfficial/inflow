...
export default function Home() {
  ...
  const pressItems = [
    {
      ...
      url: "#",
      quote: t("A powerhouse performance that left the crowd begging for more"),
    },
    {
      name: "NME",
      logo: "/images/logos/nme.png",
      url: "#",
      quote: t("Raw energy and incredible musicianship define this band"),
    },
    ...
    { name: "Billboard", logo: "/images/logos/billboard.png", url: "#" },
    {
      ...
      url: "#",
      quote: t("They have mastered the art of stadium-shaking rock"),
    },
    { name: "Metal Hammer", logo: "/images/logos/metal-hammer.png", url: "#" },
  ];

  const stats = [
    { icon: Music, value: t("50M+"), label: t("Streams") },
    { icon: Users, value: t("500K+"), label: t("Monthly Listeners") },
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Latest Single Promo */}
      <PromoSection
        subtitle={t("Latest Single")}
        title={t("Thunder Road")}
        description={t("Our most powerful track yet - a thunderous journey")}
        ctaText={t("Listen Now")}
        ctaHref="/music"
      ...
      {/* Upcoming Shows */}
      <PromoSection
        subtitle={t("Live Performances")}
        title={t("See Us Live")}
        description={t(
          "Nothing compares to the raw energy of our live performances"
        )}
        ctaText={t("View All Shows")}
      ...
      {/* Band Spotlight */}
      <PromoSection
        subtitle={t("Meet the Band")}
        title={t("The Artists Behind the Music")}
        description={t(
          "Get to know the talented musicians who pour their hearts"
        )}
        ctaText={t("Meet the Band")}
        ctaHref="/band"
